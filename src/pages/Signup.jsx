    ...
    <div className="auth-page">
      <div className="auth-container">
        <div className="auth-header">
          ...
          <p>Join Internee.pk to start your internship journey</p>
        </div>
        ...
        <div className="user-type-selector">
          ...
          <button 
            className={`type-btn ${formData.userType === 'company' ? 'active' : ''}`}
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          ...
          <button type="button" className="btn-google auth-btn">
